...
public class PseudoController {
	...
	//----------Constructeur
	public PseudoController(TableUtilisateurs table, Utilisateur user) {
		this.table = table;
		this.user = user;
	}
	...
	public void changePseudo() {
	    ...
	    SignalEnvoiBroadcastController notification = new SignalEnvoiBroadcastController();
	    notification.EnvoyerSignalChangementPseudo(Pseudo);
